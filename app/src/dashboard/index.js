    ...
    render() {
        return (
            <main>
                ...
                <div id="right-panel">
                    <label htlmFor="name-search">Name: </label>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="" method="post">
                                        <button className="button" id="delete-button" name="action" value="delete" onClick="return confirm('Are you sure you want to delete this template?');">delete</button>
